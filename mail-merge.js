 ...
 */
function doMerge() {
  var selectedTemplateId = "1rGVGEdijB9I3dh-MoqGLDup0pqJABUS5KtgX7pYmpgM";//Copy and paste the ID of the template document here (you can find this in the document's URL)
  ...
  mergedFile.setName("riempito_"+templateFile.getName());//give a custom name to the new file (otherwise it is called "copy of ...")
